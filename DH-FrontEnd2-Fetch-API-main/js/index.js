...
function renderizarDadosUsuario(dados) {
    ...
    document.getElementById("infCard").innerHTML = 
    `
    <img src="${dados.results[0].picture.medium}">
    <p>${dados.results[0].name.title} ${dados.results[0].name.first} ${dados.results[0].name.last}</p>
...
const botao = document.getElementById('random');
botao.addEventListener("click", chamaApi);
